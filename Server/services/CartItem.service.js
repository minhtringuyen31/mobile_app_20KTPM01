...
const CartItemServices = {
    ...
    async create(user_id, cart_id, product_id, quantity, size, price) {
        return await CartItemRepository.create(user_id, cart_id, product_id, quantity, size, price)
    },
    async update(id, user_id, cart_id, product_id, quantity, size, price) {
        return await CartItemRepository.update(id, user_id, cart_id, product_id, quantity, size, price)
    },
    async delete(id) {
