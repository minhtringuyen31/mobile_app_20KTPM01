...
UserRoute.get("/findAllTokenFireBase", UserController.findAllTokenFireBase)
UserRoute.post("/saveTokenFireBase", UserController.saveTokenFireBase)
UserRoute.get("/findOneTokenFirebase/:id", UserController.findOneTokenFireBase)
UserRoute.post("/sendNotification", UserController.sendNotification)
